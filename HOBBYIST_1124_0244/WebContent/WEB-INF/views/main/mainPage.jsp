<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="member.model.vo.Member, hobbyistClass.model.vo.*, hobbyistClass.model.service.HClassService, java.util.ArrayList"%>
<%
						...
						<div class="input-group">
							...
							<div class="input-group-append">
								<button class="btn btn-secondary" type="button"
									style="background-color: #9ed4c2; border-color: #9ed4c2">
						...
						<% 		for (int i = 0; i < classList.size(); i++) { %>
								...
								<div class="col-lg-4 col-sm-4">
									<div class="box_main">
										...
										<p class="price_text">
											Price <span style="color: #ff0000;"><%= classList.get(i).getClassFee() %></span>
											<!-- 좋아요 버튼 -->
											&nbsp;
										...
										<div class="tshirt_img">
											<img style="width: 75%;" src="assets/images/oilpastel2.jpeg">
										</div>
										<% } else { %>
										<%		for(HClassFile f : fileList) { %>
										<%			if(classList.get(i).getClassNo() == f.getBoardNo()) { %>
										<div class="thumbnailArea">
											<img width="100%" height="100%" src="<%= request.getContextPath() %>/uploadFiles/<%= f.getChangeName() %>"
