...
<!-- 										<label for="floatingInput"><small id="selectHelp" class="form-text text-muted">닉네임 변경은 중복확인이 필요합니다</small></label> -->
									...
									<div class="form-group">
										<label for="exampleFormControlSelect1"><b>SNS 계정</b></label>
											<div class="input-group mb-3">
												<span class="input-group-text" id="basic-addon1">⚡</span> 
												<input type="text" name="mySns" class="form-control" placeholder="SNS계정 입력" aria-describedby="basic-addon1">
											</div>
...
<!-- 										<label for="floatingInput"><small id="selectHelp" class="form-text text-muted"></small></label> -->
									...
									<div class="form-group">
										<label for="exampleFormControlSelect1"><b>자기 소개</b></label>
											<div class="input-group mb-3">
												<span class="input-group-text" id="basic-addon1">🤴</span> 
												<input type="text" name="mySns" class="form-control" placeholder="튜터님을 표현할 소개문구를 입력해 주세요" aria-describedby="basic-addon1">
											</div>
<%-- 										<input type="hidden" class="form-control" id="floatingInput" value="<%= loginUser.getMemberPhone()%>">  --%>
<!-- 										<label for="floatingInput"><small id="selectHelp" class="form-text text-muted"></small></label> -->
									</div>
									...
									<div class="row justify-content-center">
										<div class="col-2">
											<button type="submit" class="btn btn-primary">튜터 등록 하기</button>
										</div>
										<div class="col-2">
											<button type="button" class="btn btn-default" onclick="location.href='<%=request.getContextPath()%>/myInfo.me'">튜터 등록 취소</button>
										</div>
									</div>
									</form>
									</div>
