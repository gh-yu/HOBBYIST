					...
					<div class="container">
						...
						<div class="fashion_section_2">
							<div class="row">
								...
								<% } else { %>
										<%	for(int i = 0; i < classCateList.size(); i++) { %>
											<div class="col-lg-4 col-sm-4">
												<div class="box_main">
													<h4 class="shirt_text"><%= classCateList.get(i).getClassName() %></h4>
														<p class="price_text">
															<span style= "color: #9ED4C2">PRICE_ </span><span style="color: #ff0000;"><%= dc.format(classCateList.get(i).getClassFee()) %> 🛒</span> &nbsp;
															<span class="likeBtnArea">
																<input type="hidden" class="cNo" name="cNo" value="<%= classCateList.get(i).getClassNo() %>"> 
												...
												<%		if(classCateList.get(i).getClassNo() == fileList.get(j).getBoardNo()) { %> 
														<div class="thumbnailArea" style="height: 300px; width: 100%;">
																<img style="min-width:100%; height: 100%;" src="<%= request.getContextPath() %>/uploadFiles/<%= fileList.get(j).getChangeName() %>"
	...
	<%@ include file="../common/js.jsp"%>
	 <script>
		...
		$(function() {
			...
			<% if(loginUser != null && !classCateList.isEmpty()) { %>
