											...
											<div class="row justify-content-center">
												<div class="col-md-7 justify-content-center">
													<div id="fileArea"> <!-- 파일 업로드하는 부분 -->
														...
														<input type="file" id="profileImg2" multiple="multiple" name="profileImg2" onchange="LoadImg(this,2)" value="<%= request.getContextPath() %>/uploadFiles/<%= tt.getTutorImgChangeName() %>">
													</div>															
												<img class="userImg" src="<%= request.getContextPath() %>/uploadFiles/<%= tt.getTutorImgChangeName() %>" id="target_img2" name="target_img2" class="card-profile-stats-intro-pic" alt="profile-image"/>
...
<%-- 										<input type="hidden" class="form-control" id="floatingInput" value="<%= loginUser.getMemberPhone()%>">  --%>
									...
									<div class="form-group">
										...
										<div class="input-group mb-3">
											<span class="input-group-text" id="basic-addon1">📌</span> 										
											<input type="text" name="mySns" class="form-control" value="<%= tt.getTutorSns() == null ? "" : tt.getTutorSns() %> " aria-label="" aria-describedby="basic-addon1">
										</div>
									</div>	
									<div class="form-group">
										<label for="exampleFormControlSelect1"><b>자기 소개</b></label>
											<div class="input-group mb-3">
												<span class="input-group-text" id="basic-addon1">🤴</span> 
												<input type="text" name="myReport" class="form-control" value="<%= tt.getTutorReport() == null ? "" : tt.getTutorReport()%> " aria-label="" aria-describedby="basic-addon1">
											</div>
									...
									<div class="row justify-content-center">
										...
										<div class="col-2">
											<button type="submit" class="btn btn-primary">튜터 정보 수정</button>
										</div>
										</div>
									</div>
									</div>
